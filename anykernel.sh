...
# begin properties
properties() { '
kernel.string=Xcalibur kernel by @Xcalibur777
do.devicecheck=1
do.modules=0
do.systemless=1
do.cleanup=1
...
insert_line init.rc "init.rad.rc" after "import /init.usb.rc" "import /vendor/etc/init/hw/init.rad.rc";
...
## copy the script
cp  -f /tmp/anykernel/init/init.rad.rc /vendor/etc/init/hw/init.rad.rc
chmod 644 /vendor/etc/init/hw/init.rad.rc
